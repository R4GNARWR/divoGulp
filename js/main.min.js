...
const headerMenuButton=document.querySelector(".header-menu__button"),menu=document.querySelector("nav.nav");function toggleClass(e,t){e.classList.contains(t)?e.classList.remove(t):e.classList.add(t)}headerMenuButton&&headerMenuButton.addEventListener("click",()=>{headerMenuButton.classList.contains("animate")?(headerMenuButton.classList.remove("animate"),headerMenuButton.classList.add("animate-back")):(headerMenuButton.classList.add("animate"),headerMenuButton.classList.remove("animate-back")),menu&&toggleClass(menu,"active"),setTimeout(()=>{toggleClass(headerMenuButton,"active")},400),setTimeout(()=>{},500)}),Fancybox.defaults.closeButton=!1,Fancybox.bind("[data-fancybox]",{});
...
const swipersTypical=document.querySelectorAll(".swiper-typical"),mainSwiper=new Swiper(".main-swiper",{loop:!0,navigation:{nextEl:".swiper-main__next",prevEl:".swiper-main__prev"},pagination:{el:".swiper-main__pagination",type:"fraction"},breakpoints:{1:{},991:{}}});swipersTypical&&swipersTypical.forEach(i=>{const e=i.id;new Swiper("#"+e,{loop:!0,navigation:{nextEl:"."+e+"__next",prevEl:"."+e+"__prev"},pagination:{el:"."+e+"__pagination",type:"fraction"}})});
